...
#define HTTP_RULE_DEFAULT	"^1^0^admin^1234^guest^1234^admin^80^^5"
...
nvram_tuple_t nvram_factory_default[] = {                        
	...
	{ "l2tpd_rule", "0^l2tp-server^1400^1400^192.168.48.1^" 
	...
	{ "pptpd_rule", "0^pptp-server^60^1460^1482^192.168.38.1^" 
